(function ($) {
	...
	function PeMetaboxGallery(target, conf) {
		...
		var output = $('<div class="pe_gallery"><h4 id="pe_collapse">Gallery Content</h4><div class="pe_collapse"><div class="pe_controls"><div class="pe_btn_container"><input type="button" id="pe_reload" class="ob_button" value="Refresh"><p class="description">Reverts to the last saved thumbnail sequence, or if you wish to add  further images using new media tags, hitting "Refresh" will load these  new images.</p></div><div class="pe_btn_container"><input type="button" id="pe_edit" class="ob_button" value="Library"><p class="description">Takes you to the WordPress default "Media Library" where you can edit more advanced properties of the images.</p></div>'+addControlMarkup+'</div></div><div class="pe_sortable_container"><div class="pe_output ui-sortable"></div></div></div>');
		...
		output.delegate("#pe_add,#pe_collapse,a,input[type=button]","click",clickHandler);
