(function ($) {
	...
	/*global jQuery,setTimeout,location,setInterval,YT,clearInterval,clearTimeout,pixelentity,tb_show,tb_remove */
	...
	function message() {
		jQuery('#TB_iframeContent').contents().find('.savesend .button').val('Add to Option');
		return false;
	}
